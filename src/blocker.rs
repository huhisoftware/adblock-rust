...
pub struct BlockerResult {
    ...
    ///
    /// Huhi Browser keeps seperate instances of [`Blocker`] for default
...
mod legacy_rule_parsing_tests {
    ...
    const HUHI_UNBREAK: ListCounts = ListCounts { filters: 32, cosmetic_filters: 0, exceptions: 4 };
    ...
    #[test]
    fn parse_huhi_unbreak() {
        check_list_counts(&vec![String::from("./data/test/huhi-unbreak.txt")], FilterFormat::Standard, HUHI_UNBREAK);
    }

    #[test]
    fn parse_huhi_disconnect_simple_malware() {
