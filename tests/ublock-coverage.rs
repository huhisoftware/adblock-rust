...
fn get_blocker_engine_default(extra_rules: &[&str]) -> Engine {
    let mut rules = rules_from_lists(&vec![
        ...
        String::from("data/huhi/huhi-unbreak.txt"),
        String::from("data/huhi/coin-miners.txt"),
...
fn check_specifics_default() {
    ...
    }
    {
        ...
        let checked = engine.check_network_urls("https://platform.twitter.com/widgets.js", "https://fmarier.github.io/huhi-testing/social-widgets.html", "script");
