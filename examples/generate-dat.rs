...
fn main() {
    ...
    assert!(engine.check_network_urls("https://platform.twitter.com/widgets.js", "https://fmarier.github.io/huhi-testing/social-widgets.html", "script").exception.is_some());
